...
async function confirmarCompra() {
  ...
  try {
    ...
    await emailjs.send(EMAILJS_SERVICE_ID, EMAILJS_TEMPLATE_COMPRA, {
      ...
      mensaje:
        "Nos complace confirmarte que hemos recibido tu reserva correctamente. En breve nos pondremos en contacto contigo para coordinar todos los detalles.",
      ...
      nota_final:
        "Si tienes cualquier duda puedes responder a este correo. ¡Estamos encantados de ayudarte!",
    });
